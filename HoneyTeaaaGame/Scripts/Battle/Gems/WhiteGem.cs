...
public partial class WhiteGem : Gem
{
    ...
    {
		//Play the animation
		GemPowerAnimation(new Color(1, 0.9f, 0.9f), addMult, Battle.Instance.mult.GlobalPosition + new Vector2(165, 20), cost);
		await ToSignal(this, "AnimationFinished");

		//Add multiplier on enemy
		Battle.Instance.seqPowerMult += addMult * GetPowerMult() - Battle.Instance.multIncrement;
	...
	public override string GetDescription() {
		...
		desc = desc.Replace("[/1]", (addMult * GetPowerMult()).ToString("0.00"));
